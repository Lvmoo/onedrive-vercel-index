...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kay2u@msn.cn',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🔐Private folder'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:admin@lvmoo.com',
